  ...
  useEffect(() => {
    const getCategory = async () => {
      const { data } = await axios.get(
        `https://backend.mahantasvir.ir/product/${slug}`,
        {
          params: {
            model: modelFilter,
            brand: brandFilter,
  ...
  return (
    <>
      ...
      <div className="lg:flex-row flex-col-reverse mx-3 mb-[80px] mt-16 flex">
            ...
            {products
              ? products?.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-col justify-between items-center mx-3 my-2 lg:my-2">
                    ...
                    <div className="flex justify-between items-center mx-3 mt-3 md:mt-5">
                      <Link
        ...
        <div className="lg:w-[20%] mt-9 lg:mx-4">
