...
const cartReducer = (state, action) => {
  ...
  switch (action.type) {
    case "ADD_ITEMS-SUGGEST":
      if (!state.selectedItemsSuggest.find((item) => item.id === action.payload.id)) {
      ...
      case "ADD_ITEMS-PRODUCT":
        if (!state.selectedItemsProduct.find((item) => item.id === action.payload.id)) {
      ...
      case "ADD_ITEMS-ACCESS0":
        if (!state.selectedItemsAccesso.find((item) => item.id === action.payload.id)) {
      ...
      case "ADD_ITEMS_BRAND":
        if (!state.selectedItemsBeter.find((item) => item.id === action.payload.id)) {
      ...
      case "REMOVE-ITEM-SUGGEST":
          const newSelectedItems=state.selectedItemsSuggest.filter(item=>item.id !== action.payload.id)
            return{
                ...state,
      ...
      case "REMOVE-ITEM-PRODUCT":
        const newSelectedItemsProduct=state.selectedItemsProduct.filter(item=>item.id !== action.payload.id)
          return{
              ...state,
            ...
            case "REMOVE-ITEM-ACCEESO":
              const newSelectedItemsAccesso=state.selectedItemsAccesso.filter(item=>item.id !== action.payload.id)
                return{
                    ...state,
            ...
            case "REMOVE-ITEM-FROM-BRAND":
              const newSelectedItemsBrand=state.selectedItemsBeter.filter(item=>item.id !== action.payload.id)
                return{
                    ...state,
            ...
            case "INCRESS-SUGGEST":
                const indexI=state.selectedItemsSuggest.findIndex(item=>item.id===action.payload.id)
            ...
            case "INCRESS-ACCESSO":
              const indexIo=state.selectedItemsAccesso.findIndex(item=>item.id===action.payload.id)
              ...
              return{
                ...
                case "INCRESS-BRAND":
                  const indexIB=state.selectedItemsBeter.findIndex(item=>item.id===action.payload.id)
            ...
            case "DECRESS-SUGGEST":
                const indexD=state.selectedItemsSuggest.findIndex(item=>item.id===action.payload.id)
                ...
                case "DECRESS-BRAND":
                  const indexDB=state.selectedItemsBeter.findIndex(item=>item.id===action.payload.id)
                  ...
                  case "DECRESS-ACCESSO":
                    const indexDO=state.selectedItemsAccesso.findIndex(item=>item.id===action.payload.id)
